...
BTC_IMAGE=${BTC_IMAGE:-nauutilus/bitcoind}
...
curl https://raw.githubusercontent.com/nauutilus/docker-bitcoind/master/upstart.init > /etc/init/docker-bitcoind.conf
